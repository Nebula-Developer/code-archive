    ...
    <div className="m-5">
      <div className="flex justify-center">
        <div className="m-5 text-lg flex flex-col justify-center items-center space-y-5">
          ...
          <div className="container p-10 m-5 bg-slate-500 text-slate-100 rounded-lg">
            <div>
              <div className="flex flex-col space-y-5 sm:text-lg text-sm">
                <p>
                  We are here to help you and your four legged friend. Please do
                  not hesitate to contact us with any questions or concerns you
