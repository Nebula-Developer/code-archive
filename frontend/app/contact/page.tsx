...
export default Page(() => {
    ...
    return (
        <div>
            <div className="px-4 sm:px-16 lg:px-32 pb-32 mt-12 sm:mt-32">
                ...
                <div className="flex items-center w-full flex-col mt-5 sm:mt-12">
                    ...
                    <div className="flex text-xl mt-12 space-x-4 text-gray-500">
                        <span>For automatic inqueries, fill out the contact form below</span>

                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                             stroke="currentColor" className="size-6 translate-y-[2px]">
            ...
            <div className="flex justify-center m-0 sm:m-16">
