...
import { PageStyles } from "@/app/components/PageContent";
import { Editor } from "@tinymce/tinymce-react";
import { forwardRef, useEffect, useRef, useState } from "react";
import React from "react";

function TinyEditor({ preview, content, setContent }: { preview: boolean, content: string, setContent: (value: string) => void }) {
