Generated with [vike.dev/new](https://vike.dev/new) ([version 456](https://www.npmjs.com/package/create-vike/v/0.0.456)) using this command:

```sh
bun create vike@latest --solid --tailwindcss --authjs --trpc --hono --drizzle --biome
```
